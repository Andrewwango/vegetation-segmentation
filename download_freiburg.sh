...
mv freiburg_forest_annotated/val/rgb/* vegetation-segmentation/data/freiburg/test/img
mv freiburg_forest_annotated/val/GT_color/* vegetation-segmentation/data/freiburg/test/mask
